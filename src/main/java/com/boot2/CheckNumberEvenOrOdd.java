...
//            return isEvenDecimalNumber(number.doubleValue());
    ...
    public static void main(String[] args) {
        ...
        System.out.println("check number 10 even  "+ CheckNumberEvenOrOdd.isEvenNumber(10));
        System.out.println("check number 22.00 even  "+ CheckNumberEvenOrOdd.isEvenNumber(22.00));
        System.out.println("check number 9 even  "+ CheckNumberEvenOrOdd.isEvenNumber(9));
        System.out.println("check number 21.00 even  "+ CheckNumberEvenOrOdd.isEvenNumber(21.00));
        System.out.println("check number 21.20 even  "+ CheckNumberEvenOrOdd.isEvenNumber(22.20));
